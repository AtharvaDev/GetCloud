  ...
  return (
    <div className="Landing">
      ...
      >
            ...
            <div className="Landing__container">
              <div className="Landing__container__left">
                ...
                >
                  ...
                  folders, assets on-the-go, on any device. From sharing of
                  photos and videos to storing gigabytes of sensitive data,
                  DigiSpace covers it all.
                </motion.p>
              </div>
              <div
        ...
        <section ref={element} className="landing__section__two">
              ...
              <div className="Landing__container__left">
                ...
                <ul className="text-light d-flex flex-column">
                  ...
                  >
                    ...
                    <span style={{ cursor: "default" }} className="m-2">
                      Easy to set up
                    </span>
                  </motion.li>
                  <motion.li
